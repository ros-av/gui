...
$(".scan--start").click(() => {
        ...
        populateDirectory(storage); populateDirectory(path.join(storage, "scanning")); populateDirectory(path.join(storage, "quarantine")); populateDirectory(path.join(storage, "reports")); populateDirectory(path.join(storage, "plugins"));
